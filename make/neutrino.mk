...
$(D)/libstb-hal-max.do_prepare:
	...
	(cd $(ARCHIVE)/libstb-hal-max.git; git pull -q; cd "$(BUILD_TMP)";); \
	[ -d "$(ARCHIVE)/libstb-hal-max.git" ] || \
...
yaud-neutrino-mp: yaud-none \
	...
	@echo "***************************************************************************"
	@echo -e "$(TERM_GREEN_BOLD)"
	@echo " Build of neutrino-mp for $(BOXTYPE) successfully completed."
	@echo -e "$(TERM_NORMAL)"
	@echo "***************************************************************************"
	@touch $(D)/build_complete
...
yaud-neutrino-mp-plugins: yaud-none \
	...
	@echo "***************************************************************************"
	@echo -e "$(TERM_GREEN_BOLD)"
	@echo " Build of neutrino-mp with plugins for $(BOXTYPE) successfully completed."
	@echo -e "$(TERM_NORMAL)"
	@echo "***************************************************************************"
	@touch $(D)/build_complete
