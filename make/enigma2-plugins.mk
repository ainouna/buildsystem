...
$(D)/enigma2_openwebif: $(D)/bootstrap $(D)/enigma2 $(D)/python_cheetah $(D)/python_ipaddress $(D)/python_pyopenssl
	...
	$(SET) -e; cd $(BUILD_TMP)/e2openplugin-OpenWebif; \
		...
		$(SILENT)rm -f $(TARGET_DIR)/usr/lib/enigma2/python/Plugins/Extensions/OpenWebif/public/images/boxes/{h10.2h.png,h10.2s.png,h10.t.png,h11.png,h3.png,h4.png,h5.png,h6.png,h7.png,h8.2h.png,h8.png,h9.2h.png,h9.2s.png,h9combo.png,h9combose.png,h9.png,h9se.2h.png,h9se.2s.png,h9se.s.png,h9.s.png,h9.t.png,h9twin.png,h9twinse.png,h8.2h.png,h8.png,h9.2h.png,h9.2s.png,h9combose.png,h9se.2h.png,h9se.2s.png,h9se.s.png,h9.s.png,h9.t.png,h9twin.png,h9twinse.png,hzero.png,hd1100.png,hd11.png,hd1200.png,hd1265.png,hd1500.png,hd2400.png,hd500c.png,hd51.png,hd530c.png,hd60.png,hzero.png}
		$(SILENT)rm -f $(TARGET_DIR)/usr/lib/enigma2/python/Plugins/Extensions/OpenWebif/public/images/boxes/{i55plus.png,i55.png,ini-1000.jpg,ini-3000.jpg,ini-5000.jpg,ini-7000.jpg,ixussone.jpg,ixusszero.jpg,lc.png,lunix3-4k.png,lunix4k.png,lunix.png,mbmicro.png,mbmicrov2.png,mbtwinplus.png,me.jpg,minime.jpg,miraclebox.jpg,multibox.png,multiboxse.jpg}
		$(SILENT)rm -f $(TARGET_DIR)/usr/lib/enigma2/python/Plugins/Extensions/OpenWebif/public/images/boxes/{optimussos1.jpg,optimussos1plus.jpg,optimussos2.jpg,optimussos2plus.jpg,osmega.png,osmini4k.png,osminiplus.png,osmini.png,osmio4kplus.png,osmio4k.png,osninoplus.png,osnino.png,osninopro.png}
		...
		$(SILENT)rm -f $(TARGET_DIR)/usr/lib/enigma2/python/Plugins/Extensions/OpenWebif/public/images/boxes/{sf4008.png,sf8008c.png,sf8008m.png,sf8008s.png,sf8008t.png,sh1.png,spycat4kmini.png,spycatminiplus.png,spycatmini.png,spycat.png,ultra.jpg,vipercombohdd.png,vipercombo.png,viperslim.png,vipert2c.png,vs1000.png,vs1500.png,ustym4kpro.png}
		$(SILENT)rm -f $(TARGET_DIR)/usr/lib/enigma2/python/Plugins/Extensions/OpenWebif/public/images/boxes/{vuduo2.png,vuduo4k.png,vuduo4kse.png,vuduo.png,vusolo2.png,vusolo4k.png,vusolo.png,vusolose.png,vuultimo4k.png,vuultimo.png,vuuno4k.png,vuuno4kse.png,vuuno.png,vuzero4k.png,vuzero.png}
		...
		$(SILENT)rm -f $(TARGET_DIR)/usr/lib/enigma2/python/Plugins/Extensions/OpenWebif/public/images/remotes/{alphatriplehd.png,amiko1.png,amiko.png,dmm2.png,dm_normal.png,e3hd.png,e4hd.png,edision1.png,edision2.png,edision3.png,edision4.png,elite.png,et6500.png,et7000mini.png,et7x00.png,et8000.png,et_rc13_normal.png,et_rc5_normal.png,et_rc7_normal.png,formuler1.png,fusionhd.png,fusionhdse.png,galaxy4k.png,gb7252.png,gbquadplus.png,gigablue_black.png,h3.png,hd1x00.png,hd2400.png,hd60.png,i55.png,ini-1000.png,ini-3000.png,ini-5000.png,ini-7000.png,ixussone.png,ixusszero.png,lunix4k.png,me.png,miraclebox2.png,miraclebox.png,multibox.png,nbox.png,octagon.png,optimuss.png,osmini.png,premium.png,pulse4k.png,purehd.png,qviart.png,revo4k.png,sh1.png,spark.png,spycat.png,uclan.png,viperslim.png,vs1x00.png,vu_duo2.png,vu_normal_02.png,vu_normal.png,vu_ultimo.png,wetekplay.png,xcombo.png,xpeedlx.png,xp_rc14_normal.png}; 
#		Add SH4 remote pictures
