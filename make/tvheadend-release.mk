...
#
tvheadend_release_cube_common_tuner:
...
# cuberevo_9500hd
#
tvheadend_release_cuberevo_9500hd: tvheadend_release_cube_common tvheadend_release_cube_common tvheadend_release_cube_common_tuner

#
# cuberevo_2000hd
#
tvheadend_release_cuberevo_2000hd: tvheadend_release_cube_common tvheadend_release_cube_common tvheadend_release_cube_common_tuner

#
# cuberevo_250hd
#
tvheadend_release_cuberevo_250hd: tvheadend_release_cube_common tvheadend_release_cube_common tvheadend_release_cube_common_tuner

#
# cuberevo_mini_fta
#
tvheadend_release_cuberevo_mini_fta: tvheadend_release_cube_common tvheadend_release_cube_common tvheadend_release_cube_common_tuner

#
# cuberevo_mini2
#
tvheadend_release_cuberevo_mini2: tvheadend_release_cube_common tvheadend_release_cube_common tvheadend_release_cube_common_tuner

#
# cuberevo_mini
#
tvheadend_release_cuberevo_mini: tvheadend_release_cube_common tvheadend_release_cube_common tvheadend_release_cube_common_tuner

#
# cuberevo
#
tvheadend_release_cuberevo: tvheadend_release_cube_common tvheadend_release_cube_common tvheadend_release_cube_common_tuner

#
# cuberevo_3000hd
#
tvheadend_release_cuberevo_3000hd: tvheadend_release_cube_common tvheadend_release_cube_common_tuner

#
# common_ipbox
#
tvheadend_release_common_ipbox:
...
# ipbox9900
#
tvheadend_release_ipbox9900: tvheadend_release_common_ipbox
...
# ipbox99
#
tvheadend_release_ipbox99: tvheadend_release_common_ipbox
	$(SILENT)cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/frontcontroller/ipbox99xx/micom.ko $(RELEASE_DIR)/lib/modules/
	$(SILENT)cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/ipbox99xx_fan/ipbox_fan.ko $(RELEASE_DIR)/lib/modules/
	$(SILENT)cp -p $(SKEL_ROOT)/release/tvmode_ipbox $(RELEASE_DIR)/usr/bin/tvmode
...
# ipbox55
#
tvheadend_release_ipbox55: tvheadend_release_common_ipbox
...
# ufs912
#
tvheadend_release_ufs912:
	$(SILENT)install -m 0755 $(SKEL_ROOT)/release/halt_ufs912 $(RELEASE_DIR)/etc/init.d/halt
	$(SILENT)cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/frontcontroller/kathrein-micom/kathrein-micom.ko $(RELEASE_DIR)/lib/modules/
	$(SILENT)cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/frontends/*.ko $(RELEASE_DIR)/lib/modules/
...
# fortis_hdbox
#
tvheadend_release_fortis_hdbox:
...
# vitamin_hd5000
#
tvheadend_release_vitamin_hd5000:
	$(SILENT)install -m 0755 $(SKEL_ROOT)/release/halt_ufs912 $(RELEASE_DIR)/etc/init.d/halt
	$(SILENT)cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/stgfb/stmfb/stmcore-display-sti7111.ko $(RELEASE_DIR)/lib/modules/
...
# arivalink200
#
tvheadend_release_arivalink200:
	$(SILENT)cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/stgfb/stmfb/stmcore-display-stx7109c3.ko $(RELEASE_DIR)/lib/modules/
	$(SILENT)cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/frontends/*.ko $(RELEASE_DIR)/lib/modules/
...
#
# tvheadend_release_base
#
# the following target creates the common file base
tvheadend_release_base:
	@echo "=============================================================="
	@echo
	@echo -e "Start build of $(TERM_GREEN_BOLD)tvheadend_release$(TERM_NORMAL)."
...
ifeq ($(BOXTYPE), $(filter $(BOXTYPE), atevio7500 fortis_hdbox octagon1008 ufs910 ufs912 ufs913 ufs922 ufc960 spark spark7162 ipbox55 ipbox99 ipbox9900 cuberevo cuberevo_mini cuberevo_mini2 cuberevo_250hd cuberevo_2000hd cuberevo_3000hd adb_box tf7700 vitamin_hd5000))
	...
	$(SILENT)install -m 0755 $(SKEL_ROOT)/release/rcS_tvheadend_$(BOXTYPE) $(RELEASE_DIR)/etc/init.d/rcS
#
# player
#
...
# infrastructure
#
	$(SILENT)[ -e $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/infrastructure/linux/event/stm_event.ko ] && cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/infrastructure/linux/event/stm_event.ko $(RELEASE_DIR)/lib/modules || true
	$(SILENT)[ -e $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/infrastructure/linux/memsink/stm_memsink.ko ] && cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/infrastructure/linux/memsink/stm_memsink.ko $(RELEASE_DIR)/lib/modules || true
	$(SILENT)[ -e $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/infrastructure/linux/memsrc/stm_memsrc.ko ] && cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/infrastructure/linux/memsrc/stm_memsrc.ko $(RELEASE_DIR)/lib/modules || true
	$(SILENT)[ -e $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/infrastructure/linux/registry/stm_registry.ko ] && cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/infrastructure/linux/registry/stm_registry.ko $(RELEASE_DIR)/lib/modules || true
	$(SILENT)[ -e $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/infrastructure/linux/wrapper/stm_wrapper.ko ] && cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/infrastructure/linux/wrapper/stm_wrapper.ko $(RELEASE_DIR)/lib/modules || true
#
#
#
	$(SILENT)cp $(TARGET_DIR)/lib/modules/$(KERNEL_VER)/extra/simu_button/simu_button.ko $(RELEASE_DIR)/lib/modules/
ifneq ($(BOXTYPE), $(filter $(BOXTYPE), vip2 spark spark7162))
...
#
	...
	$(SILENT)cp $(TARGET_DIR)/usr/local/bin/tvheadend $(RELEASE_DIR)/usr/local/bin/
	$(SILENT)[ ! -d $(RELEASE_DIR)/.hts/tvheadend ] && mkdir -p $(RELEASE_DIR)/.hts/tvheadend 
#	$(SILENT)cp -r $(SKEL_ROOT)/root_tvheadend/.hts/tvheadend/* $(RELEASE_DIR)/.hts/tvheadend
#
# alsa
#
...
# NFS-UTILS
#
	$(SILENT)if [ -e $(TARGET_DIR)/usr/sbin/rpc.nfsd ]; then \
		cp -f $(TARGET_DIR)/etc/exports $(RELEASE_DIR)/etc/; \
		cp -f $(TARGET_DIR)/etc/init.d/nfs-common $(RELEASE_DIR)/etc/init.d/; \
		cp -f $(TARGET_DIR)/etc/init.d/nfs-kernel-server $(RELEASE_DIR)/etc/init.d/; \
...
# AUTOFS
#
	$(SILENT)if [ -d $(RELEASE_DIR)/usr/lib/autofs ]; then \
		cp -f $(TARGET_DIR)/usr/sbin/automount $(RELEASE_DIR)/usr/sbin/; \
		cp -f $(SKEL_ROOT)/etc/auto.hotplug $(RELEASE_DIR)/etc/; \
		cp -f $(SKEL_ROOT)/etc/auto.network $(RELEASE_DIR)/etc/; \
		cp -f $(SKEL_ROOT)/etc/init.d/autofs $(RELEASE_DIR)/etc/init.d/; \
...
#
$(D)/tvheadend_release: \
$(D)/%tvheadend_release: tvheadend_release_base tvheadend_release_$(BOXTYPE)
	$(TUXBOX_CUSTOMIZE)
	@touch $@
#
...
#	default for all receivers
	...
	$(SILENT)find $(OWN_BUILD)/tvheadend/ -mindepth 1 -maxdepth 1 -exec cp -at$(RELEASE_DIR)/ -- {} +
	@echo " done."
#	receiver specific (only if directory exists)
	@echo -n "Processing receiver specific own build for $(BOXTYPE)..."
	$(SILENT)[ -d "$(OWN_BUILD)/tvheadend.$(BOXTYPE)" ] && find $(OWN_BUILD)/tvheadend.$(BOXTYPE)/ -mindepth 1 -maxdepth 1 -exec cp -at$(RELEASE_DIR)/ -- {} + || true
	@echo " done."
...
# release-clean
#
tvheadend-release-clean:
	$(SILENT)rm -f $(D)/tvheadend_release
